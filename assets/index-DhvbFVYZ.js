import{d as j,r as o,j as e,A as N}from"./index-B-21U0DQ.js";import{u as E}from"./use-spring-kVpEELvh.js";import{a as H}from"./use-transform-Cylj3xKs.js";import{i as M,M as T,m}from"./proxy-BihD2B5F.js";import{u as $}from"./use-motion-value-DG1npRlY.js";function g(r,...s){const d=r.length;function c(){let l="";for(let n=0;n<d;n++){l+=r[n];const i=s[n];i&&(l+=M(i)?i.get():i)}return l}return H(s.filter(M),c)}const A=j.div`
    display: grid;
    gap: var(--space-6);
    padding: var(--space-6);
    max-width: 1100px;
