import{r as c,u as L,j as r,d as N,A as z}from"./index-CEdkCtCm.js";import{b as B,z as W,m as A,d as q,M as G}from"./proxy-KaJM56Od.js";import{u as U}from"./use-motion-value-DtvOgxle.js";import{u as Y}from"./use-transform-DNrD7_-U.js";const $=c.createContext(null);function Z(t,o,n,l){if(!l)return t;const d=t.findIndex(h=>h.value===o);if(d===-1)return t;const b=l>0?1:-1,f=t[d+b];if(!f)return t;const w=t[d],i=f.layout,g=B(i.min,i.max,.5);return b===1&&w.layout.max+n>g||b===-1&&w.layout.min+n<g?W(t,d,d+b):t}function Q({children:t,as:o="ul",axis:n="y",onReorder:l,values:d,...b},f){const w=L(()=>A[o]),i=[],g=c.useRef(!1),h={axis:n,registerItem:(m,x)=>{const u=i.findIndex(v=>m===v.value);u!==-1?i[u].layout=x[n]:i.push({value:m,layout:x[n]}),i.sort(ee)},updateOrder:(m,x,u)=>{if(g.current)return;const v=Z(i,m,x,u);i!==v&&(g.current=!0,l(v.map(X).filter(y=>d.indexOf(y)!==-1)))}};return c.useEffect(()=>{g.current=!1}),r.jsx(w,{...b,ref:f,ignoreStrict:!0,children:r.jsx($.Provider,{value:h,children:t})})}const J=c.forwardRef(Q);function X(t){return t.value}function ee(t,o){return t.layout.min-o.layout.min}function I(t,o=0){return q(t)?t:U(o)}function re({children:t,style:o={},value:n,as:l="li",onDrag:d,layout:b=!0,...f},w){const i=L(()=>A[l]),g=c.useContext($),h={x:I(o.x),y:I(o.y)},m=Y([h.x,h.y],([y,j])=>y||j?1:"unset"),{axis:x,registerItem:u,updateOrder:v}=g;return r.jsx(i,{drag:x,...f,dragSnapToOrigin:!0,style:{...o,x:h.x,y:h.y,zIndex:m},layout:b,onDrag:(y,j)=>{const{velocity:C}=j;C[x]&&v(n,h[x].get(),C[x]),d&&d(y,j)},onLayoutMeasure:y=>u(n,y),ref:w,ignoreStrict:!0,children:t})}const te=c.forwardRef(re),ae="82px",oe="66px",R={Wrapper:N.div`
        display: grid;
        gap: var(--space-6);
        padding: var(--space-6);
        max-width: 980px;
