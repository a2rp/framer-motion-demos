import{d as j,r as o,j as e,A as N}from"./index-BybwJ5J0.js";import{u as E}from"./use-spring-Dk0Zec21.js";import{a as H}from"./use-transform-Bv2NVkTi.js";import{i as M,M as T,m}from"./proxy-CWA0aJAx.js";import{u as $}from"./use-motion-value-BDGo4E3a.js";function g(r,...s){const d=r.length;function c(){let l="";for(let n=0;n<d;n++){l+=r[n];const i=s[n];i&&(l+=M(i)?i.get():i)}return l}return H(s.filter(M),c)}const A=j.div`
    display: grid;
    gap: var(--space-6);
    padding: var(--space-6);
    max-width: 1100px;
