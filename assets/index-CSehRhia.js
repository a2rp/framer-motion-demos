import{d as j,r as o,j as e,A as N}from"./index-h_xcPptR.js";import{u as E}from"./use-spring-CYxReyo2.js";import{a as H}from"./use-transform-CD_5jMDW.js";import{i as M,M as T,m}from"./proxy-BBnnFU2D.js";import{u as $}from"./use-motion-value-wRYBaFGP.js";function g(r,...s){const d=r.length;function c(){let l="";for(let n=0;n<d;n++){l+=r[n];const i=s[n];i&&(l+=M(i)?i.get():i)}return l}return H(s.filter(M),c)}const A=j.div`
    display: grid;
    gap: var(--space-6);
    padding: var(--space-6);
    max-width: 1100px;
